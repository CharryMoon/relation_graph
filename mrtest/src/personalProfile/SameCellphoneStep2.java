...
public class SameCellphoneStep2 extends Configured implements Tool {
	...
	public static class MapClass extends MapReduceBase implements
		...
		public void map(Text key, Text value,
			...
			String[] snsUserSameCellphoneTable = str.split("\001");
						
//			System.out.println("str:[" + str + "]");
//			System.out.println("snsTableLength:[" + snsUserSameCellphoneTable.length + "]");
			fromIdToId = MyStringLib.combineForKey(20, 
					snsUserSameCellphoneTable[FROM_USER_ID],
					snsUserSameCellphoneTable[TO_USER_ID]);
//			System.out.println("fromIdToId:[" + fromIdToId + "]");
			output.collect(new Text(fromIdToId), 
					new Text(snsUserSameCellphoneTable[VALUE]));
		}
	...
	public static class Reduce extends MapReduceBase implements
		...
		public void reduce(Text key, Iterator<Text> values,
			...
			while (values.hasNext()) {
				cellphones.add(values.next().toString());
				if (cellphones.size() > MAX_USERS) {
					break;
				}
			}
			
			value1 = MyStringLib.merge(cellphones, ",");
			fromId = MyStringLib.removeZeroHead(str.substring(0, 20));
			toId = MyStringLib.removeZeroHead(str.substring(20, 40));
			
//			System.out.println("str:" + str + "fromId:" + fromId + " toId:"
//						+ toId + " value1:" + value1);
			output.collect(key, new Text(MyStringLib.combine("\001", fromId, toId, TYPE, 
									String.valueOf(cellphones.size()), value1)));
		}		
	...
	public int run(String[] args) throws Exception {
		...
		JobConf job = new JobConf(conf, SameCellphoneStep2.class);
...
//		job.setMapOutputCompressorClass(GzipCodec.class);
	...
	private String getInputPath() {
		// TODO Auto-generated method stub
		String inputPath = "/group/taobao-sns/yeshao.yxq/SameCellphoneGziped/";
		System.out.println("SameCellphoneStep2.getInputPath():" + inputPath);
		return inputPath;
	}
